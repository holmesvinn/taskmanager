export const ActionTypes = {
  UPDATE_USER: "[user] update the current user data of the app",
  AVAILABLE_USERS: "[user] update the List of all AvailableUsers in the app",
  UPDATE_ERROR: "[user] update the error while fetching api data",
